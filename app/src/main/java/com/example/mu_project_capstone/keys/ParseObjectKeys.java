...
public final class ParseObjectKeys {
    ...
    public static final String CURRENT_USER_ZIPCODE_KEY = "zipcode";
    ...
    public static final String IS_SERVICE_SEEKER = "serviceSeeker";
    public static final String SERVICE_PROVIDER_DESCRIPTION_KEY = "description";
    public static final String CONTRACTOR_AVAILABILITY_CLASS = "ContractorAvailability";
    public static final String CONTRACTOR_AVAILABILITY_USER_KEY = "user";
    public static final String CONTRACTOR_AVAILABILITY_SUNDAY_KEY = "Sunday";
